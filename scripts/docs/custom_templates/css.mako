...
<%def name="mobile()" filter="minify_css">
  ...
  #sidebar {
    padding: 30px;
    overflow: hidden;
    /* ⭐️ Change background color for the sidebar */
    /* background: #f6f6f6; */
    /* background: #fdfdfd; */
    background: #fdfdfd66;
    background-image: url("mesh_background.png");
    background-blend-mode: lighten;

    /* ⭐️ Add styling to the sidebar's scrollbar */
    scrollbar-width: thin;
    /* scrollbar-color: #8d8d8d #cacaca; */
  }
    #sidebar > *:last-child {
      margin-bottom: 2cm;
    }
  ...
  #lunr-search {
    ...
    /* ⭐️ Use slightly rounded corners */
    border-radius: 20px; /* 5px; */
    /* ⭐️ Change color for later hover */
    /* background: #f5f5f5; */
    /* background: #e2ebf6cc; */
    background: #ffffffcc;
    /* ⭐️ Remove the dotted outline when selected */
    outline : 0;
  }
  /* ⭐️ Change color on hover */
  #lunr-search:hover {
    border: 1px solid #5e5c64;
  }
  /* ⭐️ Change color on focus */
  #lunr-search:focus {
  ...
  a:hover {
    /* color: #e82; */
    /* ⭐️ Change button style on hover */
    background-color: #deebfbcc;
  ...
  /* ⭐️ Change button style on activation */
  a:active {
