...
class UncoupledNonlinearVariationalSolver(NonlinearVariationalSolver):
	"""
	NonlinearVariationalSolver for uncoupling simulation and optimization. [dolfin-adjoint 2019.1.0]
	Based on: 
	...
	def solve(self, *args, **kwargs):
		...
		if annotate:
			...
			sb_kwargs = UncoupledNonlinearVariationalSolveBlock.pop_kwargs(kwargs)
			sb_kwargs.update(kwargs)
			block = UncoupledNonlinearVariationalSolveBlock(problem._ad_F == 0,
								problem._ad_u,
								problem._ad_bcs,
