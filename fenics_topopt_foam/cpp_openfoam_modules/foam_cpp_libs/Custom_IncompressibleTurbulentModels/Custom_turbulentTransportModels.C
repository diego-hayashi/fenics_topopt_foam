...
Modified by 
    Diego Hayashi Alonso (2020)

Based on
    'OpenFOAM-7/src/TurbulenceModels/incompressible/turbulentTransportModels/turbulentTransportModels.C'
    http://hassankassem.me/posts/newturbulencemodel/

\*---------------------------------------------------------------------------*/

#include "Custom_turbulentTransportModels.H"
...
#include "CustomSpalartAllmaras/CustomSpalartAllmaras.H"
makeRASModel(CustomSpalartAllmaras);
